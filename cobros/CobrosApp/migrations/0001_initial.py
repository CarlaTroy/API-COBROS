    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='studentlist', to='CobrosApp.student')),
                ('tipe_pay', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='tipopagolist', to='CobrosApp.tipe_pay')),
            ],
        ),
        migrations.AddField(
            model_name='cohorte',
