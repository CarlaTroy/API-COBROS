...
from CobrosApp.Api.Payment.views import PaymentAV, getAllByPaymentIdStudent
...
urlpatterns = [
    ...
    path('payments/student/<int:pk>',getAllByPaymentIdStudent,name='obtener-todos-pagos-estudainte'),
